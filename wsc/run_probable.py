...
for dp in wsc_datapoints[1:]:
        ...
        correct_idx_text = (np.abs(first_indices - pronoun_index_orig)).argmin()
        print(correct_idx_text, " correct_idx_text")

        pronoun_index_text = matched_pronouns[correct_idx_text][0]
        text_with_word, pronoun_index_with_word = insert_probable(dp_split[0], 0.1, pronoun_index_text)
        ...
        correct_idx_text_enhanced = (np.abs(first_indices_text_enhanced - pronoun_index_with_word)).argmin()

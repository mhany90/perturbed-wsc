...
path_to_wsc = '../data/wsc_data/enhanced.voice.syn.rel.wsc.tsv'
...
for dp in wsc_datapoints[1:]:
    ...
    if dp_split[1].replace(' ', '') != '-':
        ...
        #text = text.replace(',','')
        text_enhanced = "[CLS] " + dp_split[1]  + " [SEP]"
        #text_enhanced = text_enhanced.replace(',','')
        print(text, "text")
        ...
        tokens_pre_word_piece_A_rel = dp_split[9]
        tokens_pre_word_piece_B_rel = dp_split[11]

        pronoun = dp_split[4].strip()
        pronoun_index_orig = int(dp_split[5].strip())
        pronoun_index_orig_enhanced =  int(dp_split[8].strip())
        ...
        tokenized_option_A_rel = tokenizer.tokenize(tokens_pre_word_piece_A_rel)
        tokenized_option_B_rel = tokenizer.tokenize(tokens_pre_word_piece_B_rel)
        ...
        tokenized_option_A_len_rel = len(tokenized_option_A_rel)
        tokenized_option_B_len_rel = len(tokenized_option_B_rel)
        ...
        tokenized_text_enhanced_A = replace_pronoun(tokenized_enhanced_text, pronoun_index_text_enhanced, tokenized_option_A_rel)
        tokenized_text_enhanced_B = replace_pronoun(tokenized_enhanced_text, pronoun_index_text_enhanced, tokenized_option_B_rel)
        ...
        matched_A_text_enhanced = find_sub_list(tokenized_option_A_rel, tokenized_text_enhanced_A)
        matched_B_text_enhanced = find_sub_list(tokenized_option_B_rel, tokenized_text_enhanced_B)
        ...
        with torch.no_grad():
            ...
            print(total_logprobs_A_enhanced / tokenized_option_A_len, " total_probs_A / tokenized_option_A_len enh")
            print(total_logprobs_B_enhanced / tokenized_option_B_len, " total_probs_B / tokenized_option_B_len enh")
            print(correct_answer.strip().strip('.').replace(' ', ''), " correct_answer")
